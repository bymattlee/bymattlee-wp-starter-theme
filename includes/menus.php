	...
	** ***** ----------------------------------------------- ***** */
	...
	class Site_Nav_Walker extends Walker_Nav_Menu {
		...
		function start_lvl( &$output, $depth = 0, $args = array() ) {
			...
			$output .= "\n$indent<ul class=\"o-nav-sub_menu\">";
		}
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			$list_classes = array( 'o-nav-menu_list_item', 'js-nav-menu_list_item' );
			...
			if ( in_array( 'current-menu-item', $classes ) 
				...
				$list_classes[] = 'o-nav-menu_list_item--current';
			}

			// If class array contains 'menu-item-has-children', rename to 'has_submenu' and add to the list tag class array
			if ( in_array( 'menu-item-has-children', $classes ) ) $list_classes[] = 'o-nav-menu_list_item--has_submenu';
			...
			$attributes .= ' class="o-nav-menu_item"';
