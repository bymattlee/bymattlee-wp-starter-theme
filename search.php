...
<div data-router-wrapper>
  <div class="l-container u-grid u-gap-60 md:u-grid-cols-3 md:u-gap-80" data-router-view="search">
    <main class="md:u-col-span-2" role="main" data-s2r="group">
      <header>
        <h1 class="u-h2" data-s2r-el="block-fade-up"><?php printf( __( 'Search: %s', 'bymattlee' ), get_search_query() ); ?></h1>
      </header>
